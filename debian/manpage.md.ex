% liballocs(SECTION) | User Commands
%
% "February  6 2025"
...
liballocs - program to do something

# SYNOPSIS

**liballocs** **-e** _this_ [**\-\-example=that**] [{**-e** | **\-\-example**} _this_]
                 [{**-e** | **\-\-example**} {_this_ | _that_}]

**liballocs** [{**-h** | *\-\-help**} | {**-v** | **\-\-version**}]

# DESCRIPTION

This manual page documents briefly the **liballocs** and **bar** commands.

This manual page was written for the Debian distribution because the
original program does not have a manual page. Instead, it has documentation
in the GNU info(1) format; see below.

**liballocs** is a program that...
...
:   The system-wide configuration file to control the behaviour of
    liballocs. See **foo.conf**(5) for further details.
...
**liballocs** provides some return codes, that can be used in scripts:
...
Zoltan Meszaros <zoltan@unknown>
:   Wrote this manpage for the Debian system.

# COPYRIGHT

Copyright © 2007 Zoltan Meszaros
